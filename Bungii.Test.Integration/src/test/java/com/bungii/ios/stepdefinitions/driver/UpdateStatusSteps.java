...
public class UpdateStatusSteps extends DriverBase {
	...
	public void i_start_selected_bungii(String screen) throws Throwable {
...
/*		updateStatusPage.clickCallToCustomer();
		correct_details_should_be_displayed_to_customer_on_something_app("CALL");
		updateStatusPage.clickSMSToCustomer();
		correct_details_should_be_displayed_to_customer_on_something_app("SMS");*/
...
/*		testStepVerify.isEquals(updateStatusPage.getCustomerName(), expectedCustName,
				"Trip Information should be correctly displayed on Enroute status screen for driver",
				"Customer Name " + expectedCustName + ", should be displayed",
				"Customer Name " + expectedCustName + ", was displayed");*/
	...
	public void iShouldBeNaviagatedToTripStatusScreen(String screen) throws Throwable {
