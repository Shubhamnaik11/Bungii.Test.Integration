...
//	public WebElement Button_DuoMoreOptions2() { return findElement("(//XCUIElementTypeImage[@name=\"more\"])[2]", PageBase.LocatorType.XPath); }
	...
	public WebElement Button_DuoMoreOptions1() { return findElements("more", PageBase.LocatorType.Name).get(0); }
	public WebElement Button_DuoMoreOptions2() { return findElements("more", LocatorType.Name).get(1); }
