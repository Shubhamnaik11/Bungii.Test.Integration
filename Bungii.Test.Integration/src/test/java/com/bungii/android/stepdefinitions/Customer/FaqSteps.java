    ...
    public void i_should_see_something_on_faq_page(String strArg1) throws Throwable {
        switch (strArg1) {
            ...
            case "first answer dropdown close":
                ...
                break;
            case "last question":
                action.scrollToBottom();action.scrollToBottom();action.scrollToBottom();action.scrollToBottom();action.scrollToBottom();action.scrollToBottom();;action.scrollToBottom();
