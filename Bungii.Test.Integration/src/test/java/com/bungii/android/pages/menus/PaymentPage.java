...
//------Header-------------------------------------------------------------------------------------------------------------
    public WebElement Header_PaymentPage () { return findElement("//android.widget.TextView[@text='PAYMENT']", LocatorType.XPath); }
    ...
    public WebElement Year_2020 () { return findElement("//android.widget.TextView[@text='2020' and @instance='17']", LocatorType.XPath); }
