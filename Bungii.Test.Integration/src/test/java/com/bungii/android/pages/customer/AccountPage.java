...
public class AccountPage extends PageBase  {
    ...
    public WebElement Account_Name() { return findElement("//android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[1]/android.widget.TextView[2]", LocatorType.Id); }
    ...
    public WebElement Account_Email() { return findElement("//android.widget.ScrollView/androidx.appcompat.widget.LinearLayoutCompat/androidx.appcompat.widget.LinearLayoutCompat[3]/android.widget.TextView[2]", LocatorType.Id); }
}
