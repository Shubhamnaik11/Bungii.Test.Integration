...
public class HomePage extends PageBase {
    ...
    public WebElement Button_NavHome() { return findElement("//android.widget.TextView[@text='HOME']",LocatorType.XPath); }
    public WebElement Button_NavFAQ() { return findElement("//android.widget.TextView[@text='FAQ']",LocatorType.XPath); }
    ...
    public WebElement Button_NavAccount(boolean... ignoreException) { return findElement("//android.widget.TextView[@text='ACCOUNT']",LocatorType.XPath, ignoreException); }
    public WebElement Button_NavSchBungii() { return findElements("//android.widget.TextView[@text='SCHEDULED BUNGIIS']",LocatorType.XPath).get(2); }
    ...
    public WebElement Button_NavPayment() { return findElement("//android.widget.TextView[@text='PAYMENT']",LocatorType.XPath);}
