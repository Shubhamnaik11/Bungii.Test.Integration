...
public class EarningsPage extends PageBase {
    ...
    public WebElement Link_ItemisedEarnings() { return findElement("//android.view.View[@content-desc='Itemised earnings']", LocatorType.XPath); }
    ...
    public WebElement Text_HistoryDataTotalEarnings() { return findElement("//*[@resource-id='com.bungii.driver:id/content_main']//android.view.View[6]", LocatorType.XPath);}
