...
try{
    ...
    public void i_should_be_able_to_see_the_respective_bungii_partner_portal_trip_with_the_below_status(DataTable data) throws Throwable {
        try {
            ...
            if (status.equalsIgnoreCase("Scheduled") || (status.equalsIgnoreCase("Assigning Driver(s)") && pageName.contains("Scheduled")) || status.equalsIgnoreCase("Driver Removed")|| status.equalsIgnoreCase("Driver(s) Not Found")||status.equalsIgnoreCase("Driver Canceled")||status.equalsIgnoreCase("Customer Canceled")||status.equalsIgnoreCase("Partner Canceled")||status.equalsIgnoreCase("Admin Canceled")) {
