            ...
            switch (status) {
                case "Assigning Driver(s)":
                    ...
                    if(Heading_LiveDeliveries.contentEquals("Live Delivery List")){
                        Thread.sleep(2000);
                        String searchingDriversStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                        Thread.sleep(1000);
                        ...
                        Thread.sleep(2000);
                        String searchingDriversStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(13));
                        Thread.sleep(1000);
                        testStepAssert.isEquals(searchingDriversStatus,status,"Delivery Status should be set to Assigning Drivers","Delivery Status is set to Assigning Drivers","Delivery Status is not set to Assigning Drivers");
                ...
                case "Scheduled":
                    Thread.sleep(2000);
                    String scheduledStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(13));
                    Thread.sleep(1000);
                ...
                case "Trip Started":
                    Thread.sleep(2000);
                    String tripStartedStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                    Thread.sleep(1000);
                ...
                case  "Driver(s) Arrived":
                    Thread.sleep(2000);
                    String driversArrivedStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                    Thread.sleep(1000);
                ...
                case  "Loading Item":
                    Thread.sleep(2000);
                    String loadingItemStatus= action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                    Thread.sleep(1000);
                ...
                case "Driving To Dropoff":
                    Thread.sleep(2000);
                    String drivingToDropoffStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                    Thread.sleep(1000);
                ...
                case "Unloading Items":
                    Thread.sleep(2000);
                    String unloadingItemsStatus = action.getText(admin_ScheduledTripsPage.Text_DeliveryStatus(12));
                    Thread.sleep(1000);
