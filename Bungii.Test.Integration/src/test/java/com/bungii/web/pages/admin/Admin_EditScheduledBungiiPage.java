...
public class Admin_EditScheduledBungiiPage extends PageBase {
    ...
    public WebElement Label_SuccessMessage() { return findElement("//span[contains(text(),'Bungii Saved!')]", LocatorType.XPath); }
    ...
    public WebElement Text_Additional_Note(boolean ...ignoreException) { return findElement("//textarea[@class='form-control']",LocatorType.XPath,ignoreException);}

    public WebElement Text_Additional_Instructions() { return findElement("//textarea[@class='form-control']",LocatorType.XPath);}
    ...
    public WebElement Icon_Dropdown(){return  findElement("//tbody/tr/td[13]/div/img",LocatorType.XPath);}
