...
public class Partner_DeliveryList extends PageBase {
    ...
    public WebElement Text_Delivery_Time() {return findElement("//label[contains(text(),'ESTIMATED DELIVERY TIME')]/following-sibling::p",LocatorType.XPath);}
    ...
    public WebElement Text_Estimated_Delivery_Time() { return findElement("//td[contains(text(),'Estimated Delivery Time')]/following-sibling::td[1]",LocatorType.XPath);}
