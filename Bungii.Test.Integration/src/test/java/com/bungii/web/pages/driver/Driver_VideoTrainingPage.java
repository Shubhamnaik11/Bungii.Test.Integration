...
public class Driver_VideoTrainingPage extends PageBase {
    ...
    //Video iFrame
    public WebElement Screen_Video() { return findElement("//div[@id='divStep6']/div/div/iframe", LocatorType.XPath); }
    ...
    //Video - Viewed checkbox
    public WebElement CheckBox_Viewed() { return findElement("//input[@id='TermsnConditions.ViewedVideo']", LocatorType.XPath); }
