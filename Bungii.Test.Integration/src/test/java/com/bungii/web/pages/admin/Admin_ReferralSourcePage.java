...
public class Admin_ReferralSourcePage extends PageBase {
    ...
    public WebElement Title_ReferralSourcePage (boolean...ignoreException) { return findElement("//h4[@class='page-header' and text()='Referral Sources']", LocatorType.XPath,ignoreException); }
