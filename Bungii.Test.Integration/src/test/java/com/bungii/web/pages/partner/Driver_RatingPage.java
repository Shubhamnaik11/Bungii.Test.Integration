...
public class Driver_RatingPage extends PageBase {
    ...
    public WebElement Image_All_Ok() { return findElement("//div[@class='d-none d-md-block d-lg-block text-center desktop-1-driver col-md-3']/img[@alt='Completed']",LocatorType.XPath);}
    public WebElement Image_Stars(int i) {return findElements("//img[@alt='starFilled']",LocatorType.XPath).get(i);}
