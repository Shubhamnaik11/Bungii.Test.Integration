...
Feature: DriverMenu
  ...
  @regression
  Scenario Outline: Verify Trip Alert Settings : Trip Alerts Tab (default : 7.00AM- 9.00PM)
  ...
  @regression
  Scenario Outline: Verify Trip Alert Settings : SMS Alerts Tab (default: 7.00AM-9.00PM)
    When I enter phoneNumber :<Username> and  Password :<Password>
    And I click "Log In" button on Log In screen on driver app
    And I Select "TRIP ALERT SETTINGS" from driver App menu
    And the "TRIP ALERT SETTINGS" page is opened
