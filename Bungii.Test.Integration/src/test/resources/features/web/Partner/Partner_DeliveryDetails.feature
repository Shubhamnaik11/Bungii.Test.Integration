  ...
  Feature: Partner_DeliveryDetails
    ...
    Scenario: Verify all the fields on Delivery Details Screen
      When I request "Solo" Bungii trip in partner portal in "washingtondc" geofence
        ...
        | Solo   | 601 13th Street Northwest, Washington, United States, District of Columbia, 20005  | 234 13th Street Northeast, Washington, United States, District of Columbia, 20002   |30 minutes      |
