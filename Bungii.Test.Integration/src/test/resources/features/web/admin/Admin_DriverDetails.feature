...
#CORE-5144:Inactive driver accepting trips,driver whose status is inactive should not be eligible for delivery
  @ready
  Scenario: Inactive driver accepting trips,driver whose status is inactive should not be eligible for delivery
    ...
    And I check if driver "Testdrivertywd_appleks_a_drvca Kansas_ca" is eligible for the delivery having status "Active"
    ...
    And I check if driver "Testdrivertywd_appleks_a_drvca Kansas_ca" is eligible for the delivery having status "Inactive"