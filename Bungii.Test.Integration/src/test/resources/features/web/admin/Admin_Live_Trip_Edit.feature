...
Feature: Admin_Schedule_Trip_Edit
  ...
  Scenario: Verify editing drop off address for the Solo live trip.
    ...
    Then I should be able to see the respective bungii with the below status
      |  Status       |
      | Loading Items |
    When I click on "Edit" link beside live bungii
  ...
  @ready
    Scenario: Verify editing pickup address for the Solo live trip.
    When I request "Solo Scheduled" Bungii as a customer in "washingtondc" geofence
      | Bungii Time   | Customer Phone | Customer Name                      |
    ...
    @ready
     Scenario: Verify editing drop off address for the Partner Portal Solo live trip.
