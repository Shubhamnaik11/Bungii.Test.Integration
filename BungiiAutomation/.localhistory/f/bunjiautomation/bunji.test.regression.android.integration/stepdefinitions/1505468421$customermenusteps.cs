    ...
    public class CustomerMenuSteps //: Core
    {
      ...
      public AppiumDriver<AndroidElement> driver = AndroidManager.androiddriver;
       ...
       // ActionManager _ActionManager = new ActionManager();
         ...
         {
            ActionManager.WaitUntilIsElementExistsAndDisplayed(_SignupPage.Button_Signup);
         ...
         {         
            _UtilityFunctions.LoginToCustomerApp(_Data.CustomerPhonenumber, _Data.CustomerPassword);
             ...
             if (ActionManager.isElementPresent(_Terms.Checkbox_Agree))
             {
         ...
         {
            ActionManager.WaitUntilIsElementExistsAndDisplayed(_Menu.Homepage_Menu);
         ...
         {
            AssertionManager.ElementDisplayed(_HomePage.Link_Menu);
            _HomePage.Link_Menu.Click();         
         }
