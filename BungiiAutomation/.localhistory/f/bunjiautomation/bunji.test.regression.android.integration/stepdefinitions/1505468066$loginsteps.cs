    ...
    public class LoginSteps //:Core
    {
        ...
        public void WhenIRequestABungii()
        {
           ...
           // bool camerapermissions = _Estimate.Message_CameraPermissions.Displayed;
            if (ActionManager.isElementPresent(_Estimate.Message_CameraPermissions))
            {
            ...
            ActionManager.keyBoardEvent(AndroidKeyCode.Keycode_CAMERA);  //doesnot work in Moto G
            Thread.Sleep(2000);
           ...
           // bool requestbutton = false;//= isElementPresent(By.XPath("//android.widget.Button"));
            if (!ActionManager.isElementPresent(driver.FindElement(By.XPath("//android.widget.Button"))))
            {
        ...
        public void ThenTheUserShouldLogin()
        {
            ...
            AssertionManager.ElementDisplayed(_CustomerHome.Link_Invite);      //check if invite link is present
        }
        ...
        public void WhenIEnterMandatoryFields()
        {
            ...
            ActionManager.AddValueToScenarioContextVariable("CustomerPhoneNum", CustomerPhoneNum);
        ...
        {
            string SMSCode = _UtilityFunctions.GetVerificationCode(ActionManager.GetValueFromScenarioContextVariable("CustomerPhoneNum"));
        ...
        public void ThenIShouldBeLoggedIn()
        {
           // WebDriverWait wait = new WebDriverWait(driver, new TimeSpan(0, 0, 120));
            ...
            _Terms.Button_Continue.Click();
           // wait.Until(ExpectedConditions.ElementExists(By.Id("com.android.packageinstaller:id/permission_message")));
            ActionManager.WaitUntilIsElementExistsAndDisplayed(_Terms.Popup_PermissionsMessage);
            _Terms.Button_PermissionsAllow.Click();
            ActionManager.WaitUntilIsElementExistsAndDisplayed(_CustomerHome.Title_HomePage);
            AssertionManager.ElementDisplayed(_CustomerHome.Title_HomePage);
        }
