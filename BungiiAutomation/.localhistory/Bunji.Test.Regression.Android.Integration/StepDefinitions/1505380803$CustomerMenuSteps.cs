...
using Bunji.Test.Regression.Android.Integration.Pages;
using OpenQA.Selenium.Interactions;
using OpenQA.Selenium.Support.PageObjects;
using System.Collections.Generic;
using Bunji.Test.Regression.Android.Integration.Data;

namespace Bunji.Test.Regression.Android.Integration.StepDefinitions
{
    [Binding]
    public class CustomerMenuSteps: Core
    {
        ...
        public AppiumDriver<AndroidElement> driver = Core.driver;
        LoginPageElements _LoginPage = new LoginPageElements(Core.driver);
        SearchingPageElements _SearchingDriver = new SearchingPageElements(Core.driver);
        CustomerHomePageElements _CustomerHome = new CustomerHomePageElements(Core.driver);
        EstimatePageElements _Estimate = new EstimatePageElements(Core.driver);
        TermsPageElements _Terms = new TermsPageElements(Core.driver);
        CustomerData _Data = new CustomerData();
        SignupPageElements _SignupPage = new SignupPageElements(Core.driver);
        MenuElements _Menu = new MenuElements();

        //[Given(@"I have launched the app")]
        //public void GivenIHaveLaunchedTheApp()
        //{
        //   // driver = Core.BungiiCustomerLaunchSamsung(); //launch Bungii Customer app
        ...
        //    //PageFactory.InitElements(driver, _Menu);
        //}
        ...
        public void GivenIAmOnCustomerLoggedInHomePage()
        {
            ...
            Assert.IsTrue(_CustomerHome.Link_Invite.Displayed);  
        }
